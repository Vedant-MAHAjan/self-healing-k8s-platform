...
from ..models import Issue, Diagnosis, RemediationStrategy
from .providers.mock_provider import MockAIProvider
from .prompts import build_diagnosis_prompt
from ..utils.metrics import ai_diagnosis_duration
...
class AIEngine:
    ...
    async def diagnose(self, issue: Issue) -> Diagnosis:
        ...
        try:
            ...
            ai_diagnosis_duration.labels(issue_type=issue.issue_type.value).observe(duration)
